...
- Worker: снимки Partners API, расчёт дня, freeze в 23:59 Dubai
- Telegram: топ-7 каждый час (когда задан токен бота)

Сутки считаются по **Asia/Dubai (UTC+4)**. Вход: регистрация на сайте + депозит за сегодня (по умолчанию от $50, настраивается). Вывод не дисквалифицирует, но снижает место в рейтинге.
